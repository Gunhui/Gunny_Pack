...
public class TMGCSYS {
	public static String tmgcVersion = "0.2.0 Official";      // 객체화에 상관업싱 지속적으로 사용이 가능한 것들을 미리 올려놓기 위해 사용
	...
	public static int tmgcCountPlay=0, tmgcCountStudy=0;	// 놀기 횟수, 공부 횟수
